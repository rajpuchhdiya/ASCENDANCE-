...
class ACF_Fields {
    ...
    public function register_field_groups() {
        ...
        // 7. Entity Intelligence Field Group
        acf_add_local_field_group( array(
            'key' => 'group_ascendance_entity',
            'title' => __( 'Entity Intelligence Metadata', 'ascendance-core' ),
            'fields' => array(
                array(
                    'key' => 'field_entity_official_name',
                    'label' => __( 'Official Legal Name', 'ascendance-core' ),
                    'name' => 'official_name',
                    'type' => 'text',
                    'instructions' => __( 'Full official or corporate registered name.', 'ascendance-core' ),
                    'required' => 0,
                ),
                array(
                    'key' => 'field_entity_alternate_names',
                    'label' => __( 'Alternate Names / Aliases / Tickers', 'ascendance-core' ),
                    'name' => 'alternate_names',
                    'type' => 'textarea',
                    'instructions' => __( 'One alias or acronym per line (e.g., "CMOC", "China Moly"). Used for search matching.', 'ascendance-core' ),
                    'required' => 0,
                    'rows' => 3,
                ),
                array(
                    'key' => 'field_entity_short_description',
                    'label' => __( 'Short Description', 'ascendance-core' ),
                    'name' => 'short_description',
                    'type' => 'textarea',
                    'instructions' => __( 'High-level public description of the entity.', 'ascendance-core' ),
                    'required' => 0,
                    'rows' => 3,
                ),
                array(
                    'key' => 'field_entity_country',
                    'label' => __( 'Country / Jurisdiction', 'ascendance-core' ),
                    'name' => 'country',
                    'type' => 'text',
                    'instructions' => __( 'Primary country or state jurisdiction (e.g., "Democratic Republic of the Congo").', 'ascendance-core' ),
                    'required' => 0,
                ),
                array(
                    'key' => 'field_entity_website',
                    'label' => __( 'Official Website', 'ascendance-core' ),
                    'name' => 'website',
                    'type' => 'text',
                    'instructions' => __( 'Official URL (e.g., "https://www.example.com").', 'ascendance-core' ),
                    'required' => 0,
                ),
                array(
                    'key' => 'field_entity_status',
                    'label' => __( 'Entity Status', 'ascendance-core' ),
                    'name' => 'entity_status',
                    'type' => 'select',
                    'choices' => array(
                        'active'    => __( 'Active', 'ascendance-core' ),
                        'inactive'  => __( 'Inactive', 'ascendance-core' ),
                        'proposed'  => __( 'Proposed', 'ascendance-core' ),
                        'suspended' => __( 'Suspended', 'ascendance-core' ),
                        'completed' => __( 'Completed', 'ascendance-core' ),
                    ),
                    'default_value' => 'active',
                    'required' => 0,
                ),
                array(
                    'key' => 'field_entity_established_date',
                    'label' => __( 'Established / Start Date', 'ascendance-core' ),
                    'name' => 'established_date',
                    'type' => 'text',
                    'instructions' => __( 'Founding year or project start date (e.g., "2006").', 'ascendance-core' ),
                    'required' => 0,
                ),
            ),
            'location' => array(
